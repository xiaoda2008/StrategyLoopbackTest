...
-- 创建数据库
CREATE DATABASE stdb CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
-- insert into u_data_desc (content_name,content,comments) values ('adjdata_stockcode_update_to','','the stock code of last update of adjdata');
